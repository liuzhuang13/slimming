...
# 1. Train vgg network with channel level sparsity, S is the lambda in the paper which controls its significance
th main_bn.lua -netType vgg -save vgg_cifar10/ -S 0.0001
