mkdir results/
mkdir results/example_vgg_cifar10/
mkdir results/example_vgg_cifar10/pruned
mkdir results/example_vgg_cifar10/converted
mkdir results/example_vgg_cifar10/fine_tune
